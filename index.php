    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="image/img.jpg" width=100 height=100 alt="Mrunal Rajendra Sharma" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a href="https://www.linkedin.com/in/mrunal-sharma-14072000m/"
                style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on LinkedIn">Mrunal Sharma</a>
