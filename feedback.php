...
<div class="col-md-10">
<a href="mailto: sharma14.mrunal@gmail.com" style="color:#000000">sharma14.mrunal@gmail.com</a><br /><br />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="image/img.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a href="https://www.linkedin.com/in/mrunal-sharma-14072000m/" style="color:#202020; font-family:'typo' ; font-size:18px"
                title="Find on Facebook">Mrunal Sharma</a>
              <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-9981903605</h4>
              <h4 style="font-family:'typo' ">sharma14.mrunal@gmail.com</h4>
              <h4 style="font-family:'typo' ">Shri Vaishnav Vidyapeeth Vishwavidhyalaya , Indore</h4>
            </div>
          </div>
          </p>
        </div>
